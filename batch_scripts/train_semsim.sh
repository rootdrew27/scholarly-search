...
#SBATCH --job-name="Train SemSim Model"     # What is your job called?

#SBATCH --output=output/train_semsim.txt     # Output file - Use %j to inject job id, like output-%j.txt

#SBATCH --error=error/train_semsim.txt       # Error file - Use %j to inject job id, like error-%j.txt
...
python3.9 ./py_code/train_semsim.py
